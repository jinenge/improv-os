...
export const UI = {
  ...
  heart: `<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M8 13.4 C8 13.4 1.8 9.8 1.8 5.7 A3.1 3.1 0 0 1 8 4.5 A3.1 3.1 0 0 1 14.2 5.7 C14.2 9.8 8 13.4 8 13.4 Z"/></svg>`,
  heartFilled: `<svg viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M8 13.4 C8 13.4 1.8 9.8 1.8 5.7 A3.1 3.1 0 0 1 8 4.5 A3.1 3.1 0 0 1 14.2 5.7 C14.2 9.8 8 13.4 8 13.4 Z"/></svg>`,
  eye: `<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M1 8 s2.6 -4.6 7 -4.6 S15 8 15 8 s-2.6 4.6 -7 4.6 S1 8 1 8 Z"/><circle cx="8" cy="8" r="1.9"/></svg>`,
